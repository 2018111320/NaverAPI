...
# 모듈3: Naver Search Trend API + Docker + AWS
    # Python version : 3.8.10
    # Docker version : 20.10.7
    # AWS EC2 Instance AMI version : Ubuntu Server 20.04 LTS (HVM), SSD Volume Type
    # AWS EC2 service : Auto Scaling Group, Load Balancer
    # imported library
        # Main : numpy, CrawlVisual, matplotlib, WordCloud, PIL
        # DataAuth : .
        # DataCrawl : typing, datetime, urllib
